    ...
    <div class="panel-heading">        
        <form class="form-inline">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <input class="form-control" type="text" placeholder="Pencarian. . ." name="q" value="<?=$_GET['q']?>" style="width: 850px" />   
                </div>
                <div class="col-sm-2">
                    <div class="dropdown">
...
<div class="table-responsive">
    <table class="table table-bordered table-hover table-striped bg-info">
        ...
        WHERE nama_tempat LIKE '%$q%' AND tb_tempat.id_kategori = '$_GET[ID]'
        ORDER BY id_tempat";
