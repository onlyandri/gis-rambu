...
<div class="page-header">
    <h1>Pengaduan Tempat </h1>
</div>

<form method="post" action="?m=pengajuan_tambah" enctype="multipart/form-data">    
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <textarea class="mce" id="keterangan" name="keterangan"><?=$_POST['keterangan']?></textarea>
            </div>
            <div class="form-group">
                <button class="btn btn-primary" onclick="return confirm('Are you sure?')" ><span class="glyphicon glyphicon-save"></span> Ajukan sekarang</button>
