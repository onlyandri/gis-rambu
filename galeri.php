...
<div class="panel panel-info">
    <div class="panel-heading">        
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-success" href="?m=galeri"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
    ...
    <div class="oxa">
        <table class="table table-bordered table-hover table-striped bg-info">
            ...
            <tr>
                ...
                <td>
                    <img class="thumbnail" src="assets/images/galeri/small_<?=$row->gambar?>" height="70" />
                </td>
